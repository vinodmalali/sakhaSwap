...
interface Ilogic {
    function getAmtSg(int amountADesired, int amountBDesired) external view returns (uint);
}
...
contract Sakha is ERC20 {
    ...
    function reward(address to,int amountADesired, int amountBDesired) external  {
